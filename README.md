...
2. An installation of the [CUDA Toolkit](https://developer.nvidia.com/cuda-downloads)
3. An installation of [Python](https://www.python.org/downloads/)
4. [PIP](https://pypi.org/project/pip/) for python
...
Since this algorithm reduces the dimensionality of the input data down to 2 dimensions, the final embedding may not be fully representative of the input data.
The embeddings generated by this algorithm should be used exclusively for exploratory data analysis and visualisation, such as finding underlying structure or relationships in the dataset.
The embeddings should not be used for definitive conclusions or making important decisions.
